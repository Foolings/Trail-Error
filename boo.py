...
name = input()
print ("Hello, {}! Welcome to my show!" .format(name))
...
if guess==4:
	...
	print ("Sorry, that's incorrect. The number was {}." .format(random_num)) 
...
if guess3==4:
	...
	print ("Well, {}, you are taking home 15,000 dollars!" .format(name))
...
guess4 = int(input())
if guess4==4:
	print ("Congratulations, {}! You are this week's lucky winner!" .format(name))
